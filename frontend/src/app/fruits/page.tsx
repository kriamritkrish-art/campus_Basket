    ...
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8 space-y-4 sm:space-y-6">
      ...
      <div className="bg-white p-4 sm:p-8 rounded-2xl border border-gray-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4 sm:gap-6">
        <div>
          ...
          <h1 className="text-xl sm:text-3xl font-black text-gray-900 tracking-tight">Fresh Farm Fruits</h1>
        ...
        <div className="bg-[#f1f8e9] border border-[#dcedc8] rounded-xl p-3.5 text-xs text-gray-800 flex items-center gap-3 shrink-0">
