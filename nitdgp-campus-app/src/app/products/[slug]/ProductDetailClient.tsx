...
export default function ProductDetailPage() {
  ...
  const [imgSrc, setImgSrc] = useState('https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=800');
          ...
          <img
            ...
            onError={() => {
              ...
              if (fallback && fallback !== imgSrc) {
                ...
                setImgSrc('https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=800');
              }
            }}
