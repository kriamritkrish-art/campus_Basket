...
export const fallbackProducts = [
  // FOOD & MEALS
  {
    ...
    images: [{ id: 'img_momo_veg', googleDriveUrl: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=800', isPrimary: true }],
  ...
  },
  {
    ...
    isFeatured: true,
    deliveryTime: '15-25 mins',
    images: [{ id: 'img_momo_chk', googleDriveUrl: 'https://images.unsplash.com/photo-1534422298391-e4f8c172dddb?w=800', isPrimary: true }],
...
export const fallbackUsers = [
  ...
  // Service Provider 5 (ABC Provider - Fast Food & Canteen)
  {
    id: 'user_prov_abc',
    username: 'SP_ABC_01',
    email: 'abc.canteen@nitdgp.ac.in',
    personalEmail: 'abc.canteen@gmail.com',
    passwordHash: HASH_VENDOR,
    role: 'SERVICE_PROVIDER' as const,
    isActive: true,
    createdAt: new Date('2026-01-10'),
    ...
    provider: {
      id: 'prov_abc',
      userId: 'user_prov_abc',
      fullName: 'ABC Provider',
      contactPerson: 'ABC Fast Food & Canteen',
  ...
  // Delivery Boy 3 (Sourav Senapati - Primary Runner)
  {
    id: 'user_db_boy_sourav_1',
    username: 'DB_SOURAV_01',
    email: 'sourav.runner1@campusbasket.in',
    ...
    deliveryBoy: {
      id: 'db_boy_sourav_1',
      userId: 'user_db_boy_sourav_1',
      fullName: 'Sourav Senapati',
      mobileNumber: '8972495205',
      vehicleType: 'Campus Bicycle',
      activeStatus: true,
      currentZone: 'ALL',
      paymentType: 'PER_DELIVERY' as const,
  ...
  // Delivery Boy 4 (Sourav Senapati - Secondary Runner)
  {
    id: 'user_db_boy_sourav_2',
    username: 'DB_SOURAV_02',
    email: 'sourav.runner2@campusbasket.in',
    personalEmail: 'souravsenapati408@gmail.com',
    passwordHash: HASH_DELIVERY,
    role: 'DELIVERY_BOY' as const,
    isActive: true,
    ...
    deliveryBoy: {
      id: 'db_boy_sourav_2',
      userId: 'user_db_boy_sourav_2',
      fullName: 'Sourav Senapati',
      mobileNumber: '8388086844',
      vehicleType: 'Fast E-Cycle',
      activeStatus: true,
      currentZone: 'ALL',
      paymentType: 'PER_DELIVERY' as const,
      perDeliveryRate: 15.00,
...
export const fallbackOrders = [
  {
    id: 'ord_cod_sourav_101',
    orderNumber: 'NIT-ORD-9101',
    ...
    student: { fullName: 'Rohit Sharma', mobileNumber: '9876505678', hallName: 'Hall 2', roomNumber: 'A-102' },
    provider: { id: 'prov_canteen', fullName: 'Campus Food & Cafeteria Vendor', mobileNumber: '9876543211' },
    deliveryBoy: { id: 'db_boy_sourav_1', fullName: 'Sourav Senapati', mobileNumber: '8972495205', vehicleType: 'Campus Bicycle' },
    items: [{ id: 'item_cod_101', productName: 'Kolkata Chicken Biryani Special', quantity: 2, unitPrice: 140, totalPrice: 280 }]
  },
  {
    id: 'ord_cod_sourav_102',
    orderNumber: 'NIT-ORD-9102',
    ...
    student: { fullName: 'Priya Mukherjee', mobileNumber: '9876509876', hallName: 'Hall 7', roomNumber: 'C-204' },
    provider: { id: 'prov_canteen', fullName: 'Campus Food & Cafeteria Vendor', mobileNumber: '9876543211' },
    deliveryBoy: { id: 'db_boy_sourav_1', fullName: 'Sourav Senapati', mobileNumber: '8972495205', vehicleType: 'Campus Bicycle' },
    items: [{ id: 'item_cod_102', productName: 'Paneer Butter Masala Combo', quantity: 2, unitPrice: 170, totalPrice: 340 }]
  },
  {
    id: 'ord_cod_sourav_103',
    orderNumber: 'NIT-ORD-9103',
    studentId: 'stud_arun',
    providerId: 'prov_canteen',
    deliveryBoyId: 'db_boy_sourav_1',
    serviceType: 'FOOD',
    ...
    providerPayable: 180.5,
    hallName: 'Hall 5',
    hallNumber: '5',
    roomNumber: 'B-201',
    deliveryOtp: '194028',
    deliveryOtpVerified: true,
    deliveredAt: new Date(Date.now() - 3600000 * 3),
    createdAt: new Date(Date.now() - 3600000 * 4),
    updatedAt: new Date(Date.now() - 3600000 * 3),
    student: { fullName: 'Arunav Roy', mobileNumber: '9876503456', hallName: 'Hall 5', roomNumber: 'B-201' },
    provider: { id: 'prov_canteen', fullName: 'Campus Food & Cafeteria Vendor', mobileNumber: '9876543211' },
    deliveryBoy: { id: 'db_boy_sourav_1', fullName: 'Sourav Senapati', mobileNumber: '8972495205', vehicleType: 'Campus Bicycle' },
    items: [{ id: 'item_cod_103', productName: 'Double Egg Chicken Kathi Roll', quantity: 2, unitPrice: 95, totalPrice: 190 }]
  },
  {
    id: 'ord_cod_sourav_104',
    orderNumber: 'NIT-ORD-9104',
    studentId: 'stud_rohit',
    providerId: 'prov_fruits',
    deliveryBoyId: 'db_boy_sourav_2',
    ...
    updatedAt: new Date(Date.now() - 3600000 * 4),
    student: { fullName: 'Rohit Sharma', mobileNumber: '9876505678', hallName: 'Hall 2', roomNumber: 'A-102' },
    provider: { id: 'prov_fruits', fullName: 'Green Basket Campus Fresh Fruits', mobileNumber: '9876543212' },
    deliveryBoy: { id: 'db_boy_sourav_2', fullName: 'Sourav Senapati', mobileNumber: '8388086844', vehicleType: 'Fast E-Cycle' },
    items: [{ id: 'item_cod_104', productName: 'Shimla Fresh Apple & Sweet Orange Basket', quantity: 1, unitPrice: 450, totalPrice: 450 }]
  },
  {
    id: 'ord_cod_sourav_105',
    orderNumber: 'NIT-ORD-9105',
    studentId: 'stud_arun',
    providerId: 'prov_general',
    deliveryBoyId: 'db_boy_sourav_2',
    ...
    updatedAt: new Date(Date.now() - 3600000 * 3),
    student: { fullName: 'Arunav Roy', mobileNumber: '9876503456', hallName: 'Hall 5', roomNumber: 'B-201' },
    provider: { id: 'prov_general', fullName: 'Campus Daily Essentials Store', mobileNumber: '9876543210' },
    deliveryBoy: { id: 'db_boy_sourav_2', fullName: 'Sourav Senapati', mobileNumber: '8388086844', vehicleType: 'Fast E-Cycle' },
    items: [{ id: 'item_cod_105', productName: 'Engineering Practical Lab Sheets & Pen Pack', quantity: 1, unitPrice: 260, totalPrice: 260 }]
  },
  {
    id: 'ord_cod_lead_106',
    orderNumber: 'NIT-ORD-9106',
    studentId: 'stud_priya',
    providerId: 'prov_canteen',
    ...
    student: { fullName: 'Priya Mukherjee', mobileNumber: '9876509876', hallName: 'Hall 7', roomNumber: 'C-204' },
    provider: { id: 'prov_canteen', fullName: 'Campus Food & Cafeteria Vendor', mobileNumber: '9876543211' },
    deliveryBoy: { id: 'db_boy_1', fullName: 'Bikash Mondal (Lead Runner)', mobileNumber: '9876543220', vehicleType: 'Hero Hawk Cycle' },
    items: [{ id: 'item_cod_106', productName: 'Special South Indian Meal Platter', quantity: 2, unitPrice: 160, totalPrice: 320 }]
  },
  {
    id: 'ord_cod_lead_107',
    orderNumber: 'NIT-ORD-9107',
    studentId: 'stud_rohit',
    providerId: 'prov_canteen',
    deliveryBoyId: 'db_boy_1',
    serviceType: 'FOOD',
    ...
    provider: { id: 'prov_canteen', fullName: 'Campus Food & Cafeteria Vendor', mobileNumber: '9876543211' },
    deliveryBoy: { id: 'db_boy_1', fullName: 'Bikash Mondal (Lead Runner)', mobileNumber: '9876543220', vehicleType: 'Hero Hawk Cycle' },
    items: [{ id: 'item_cod_107', productName: 'Paneer Butter Masala Combo', quantity: 1, unitPrice: 280, totalPrice: 280 }]
  },
  {
...
export const fallbackSettings = [
  ...
  { id: 'set_28', key: 'AI_AGENT_STATUS', value: 'ON', description: 'Global master switch for Campus Basket AI Shopping Assistant (ON / OFF)' },
  { id: 'set_29', key: 'AI_OPERATING_MODE', value: 'HYBRID', description: 'AI Assistant Operating Mode: FULL_AI | HYBRID | UI_ONLY' },
  { id: 'set_30', key: 'AI_DAILY_LIMIT', value: '500', description: 'Max daily backend AI request allowance before auto-fallback to UI ONLY' },
  { id: 'set_31', key: 'AI_MONTHLY_LIMIT', value: '15000', description: 'Max monthly backend AI request allowance' },
  { id: 'set_32', key: 'AI_WARNING_THRESHOLD', value: '80', description: 'AI quota warning alert percentage threshold' },
  { id: 'set_33', key: 'AI_CRITICAL_THRESHOLD', value: '90', description: 'AI quota critical alert percentage threshold' }
];
...
export const fallbackCodCollections = [
  {
    id: 'cod_col_sourav_101',
    orderId: 'ord_cod_sourav_101',
    deliveryBoyId: 'db_boy_sourav_1',
    amountExpected: 280.00,
    amountCollected: 280.00,
    difference: 0.00,
    collectionStatus: 'COLLECTED',
    reconciliationStatus: 'PENDING',
    reconciliationNotes: 'Doorstep cash collected by runner; pending admin verification.',
    collectedAt: pastDays(0, 5),
    createdAt: pastDays(0, 6),
    updatedAt: pastDays(0, 5)
  },
  {
    id: 'cod_col_sourav_102',
    orderId: 'ord_cod_sourav_102',
    deliveryBoyId: 'db_boy_sourav_1',
    amountExpected: 340.00,
    amountCollected: 340.00,
    difference: 0.00,
    collectionStatus: 'COLLECTED',
    reconciliationStatus: 'PENDING',
    reconciliationNotes: 'Doorstep cash collected by runner; pending admin verification.',
    collectedAt: pastDays(0, 4),
    createdAt: pastDays(0, 5),
    updatedAt: pastDays(0, 4)
  },
  {
    id: 'cod_col_sourav_103',
    orderId: 'ord_cod_sourav_103',
    deliveryBoyId: 'db_boy_sourav_1',
    amountExpected: 190.00,
    amountCollected: 190.00,
    difference: 0.00,
    collectionStatus: 'COLLECTED',
    reconciliationStatus: 'PENDING',
    reconciliationNotes: 'Doorstep cash collected by runner; pending admin verification.',
    collectedAt: pastDays(0, 3),
    createdAt: pastDays(0, 4),
    updatedAt: pastDays(0, 3)
  },
  {
    id: 'cod_col_sourav_104',
    orderId: 'ord_cod_sourav_104',
    deliveryBoyId: 'db_boy_sourav_2',
    amountExpected: 450.00,
    amountCollected: 450.00,
    difference: 0.00,
    collectionStatus: 'COLLECTED',
    reconciliationStatus: 'PENDING',
    reconciliationNotes: 'Doorstep cash collected by runner; pending admin verification.',
  ...
  {
    id: 'cod_col_sourav_105',
    orderId: 'ord_cod_sourav_105',
    deliveryBoyId: 'db_boy_sourav_2',
    amountExpected: 260.00,
    amountCollected: 260.00,
    difference: 0.00,
    collectionStatus: 'COLLECTED',
    reconciliationStatus: 'PENDING',
    reconciliationNotes: 'Doorstep cash collected by runner; pending admin verification.',
  ...
  {
    id: 'cod_col_lead_106',
    orderId: 'ord_cod_lead_106',
    deliveryBoyId: 'db_boy_1',
    amountExpected: 320.00,
